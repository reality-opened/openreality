...
The `mcp/` component of the public `reality-opened/openreality` monorepo
(npm `openreality-mcp`): Open Reality OS as MCP tools. An **all-plugin [cordis](https://github.com/cordiverse/cordis)
